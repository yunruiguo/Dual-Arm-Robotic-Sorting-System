...
inline RotMatrix Angaxis2Rot(Eigen::Vector3d &agax3) {
  Eigen::Vector3d rvec;
  double angle;
  //If all input values are0,angle0,cannot be used as the denominator
  if (!agax3[0] && !agax3[1] && !agax3[2]) {
    ...
    rvec =
        Eigen::Vector3d(agax3[0] / angle, agax3[1] / angle, agax3[2] / angle);
...
inline Eigen::Vector3d Rot2Angaxis(RotMatrix &r) {
  Eigen::Matrix3d rotationMatrix;
  rotationMatrix << r.x.x, r.y.x, r.z.x, r.x.y, r.y.y, r.z.y, r.x.z, r.y.z,
      r.z.z;
