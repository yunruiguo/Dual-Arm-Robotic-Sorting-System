...
LastEditTime: 2025-04-02 22:20:26
...
class GraspTaskManager(Node):
    ...
    def grasp4D_place(self):
        if self.grasp_info["x"]!=0.0:
            ...
            # print(W)
            # print(0 if W > 95 else 1 - (W / 95) * 1.00)
    ...
    def test(self):
        ...
        self.add_action_to_sequence(
            ...
            (0, 1),
            decision_logic=(None, None),
            kwargs1={'tcp': [0.16690,-1.104936,0.484810,1.726707,0.0,-0.053269]},
            kwargs2={'tcp': [-0.263265,-1.0820139,0.584060,-1.722650,0.025201,3.103612]},
        )
    def place_object(self):
        ...
        self.add_action_to_sequence(
            ...
            (1, None),
            decision_logic=(None, None),
            kwargs1={'tcp': [305.23+10,4.00-10,-145.00,3.1416,0.0,1.5808]},
        )
        self.add_action_to_sequence(
            ("moveTo", None), 
            (1, None),
            decision_logic=(None, None),
            kwargs1={'tcp': [305.23-1,4.00+1,-140.00,3.1416,0.0,1.5808]},
        )
        self.add_action_to_sequence(
            ("openGripper", None), 
            (1, None),
